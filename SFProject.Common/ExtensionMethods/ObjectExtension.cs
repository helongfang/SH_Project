    ...
    public static class ObjectExtension
    {
        ...
        public static string YearMonthDay(this DateTime? t)
        {
            ...
            if (t.HasValue)
            {
                try
                {
                    string newTime = Convert.ToDateTime(t).ToString("yyyy-MM-dd");
                    time = newTime;
                }
                catch (Exception)
                {
        ...
        public static string YYYYMMDDHHMM(this DateTime t)
        {
            string time = string.Empty;

            try
            {
                string newTime = Convert.ToDateTime(t).ToString("yyyy-MM-dd HH:mm");
                time = newTime;
            }
            catch (Exception)
            {
