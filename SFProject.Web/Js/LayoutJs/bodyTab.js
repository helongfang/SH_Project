                ...
                for (var j = 0; j < data[i].children.length; j++) {
                    ...
                    if (data[i].children[j].children != undefined && data[i].children[j].children.length > 0) {
                        ...
                        if (data[i].children[j].target == "_blank") {
                            ulHtml += '<li class="layui-nav-item layui-nav-item-2"><a style="padding-left: 20px;" href="javascript:;" data-url="' + data[i].children[j].href + '" target="' + data[i].children[j].target + '">';
                        } else {
                            ulHtml += '<li class="layui-nav-item layui-nav-item-2"><a style="padding-left: 20px;" href="javascript:;" data-url="' + data[i].children[j].href + '">';
                        }
                        ...
                        for (var k = 0; k < data[i].children[j].children.length; k++)
                        {
                            if (data[i].children[j].children[k].target == "_blank") {
                                ulHtml += '<dd class="layui-nav-item layui-nav-item-2"><a data-url="' + data[i].children[j].children[k].href + '" target="' + data[i].children[j].children[k].target + '">';
                            } else {
                                ulHtml += '<dd class="layui-nav-item layui-nav-item-2"><a data-url="' + data[i].children[j].children[k].href + '">';
                            }
